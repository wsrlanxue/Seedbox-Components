function qBittorrent_download {
    ...
    wget https://raw.githubusercontent.com/wsrlanxue/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qBittorrent/qBittorrent%20$qBver%20-%20$libver/qbittorrent-nox && chmod +x $HOME/qbittorrent-nox
}
...
#        wget  https://raw.githubusercontent.com/wsrlanxue/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qb_password_gen && chmod +x $HOME/qb_password_gen
...
Downloads\SavePath=/home/$username/qbittorrent/Downloads/
Queueing\QueueingEnabled=false
WebUI\Password_PBKDF2="@ByteArray(Not1vVhJQdDR+kN1qTEovg==:BCa2IB/LV0Ix1ndUQEcVz4xHBCgiIJ0B8DpmN9OG3E2yJUPwECQHjvigHmM6oKUARTx/kahbXVL7sn/Ryyi8jg==)"
WebUI\Port=8080
WebUI\Username=$username
EOF
